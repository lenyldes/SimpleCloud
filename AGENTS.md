...
- **Workflow:** 
  ...
  5. **Synthesis & Handoff:** Synthesizes verified findings into the final audit report, updates `BUGS.md` if applicable, highlights `[SUGGESTION]` items in the dedicated user section, and outputs the next copy-paste handoff prompt.
